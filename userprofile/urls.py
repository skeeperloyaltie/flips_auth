...
from .views import UserProfileView, UpdateUserView, UpdatePasswordView, DeleteAccountView, SendPasswordResetEmailView, PasswordResetConfirmView, VerifyResetTokenView, AcceptPrivacyPolicyView
